    ...
    if (kind === "pt") {
      return (
        <View key={key}>
          ...
          <Text>
            Start Date: {membership[kind].start.toDate().toLocaleString()}
          </Text>
      ...
      return (
        <View key={key}>
          <Text>{enToKo(kind)}</Text>
          <Text>Membership Months: {membership[kind].month} months</Text>
          <Text>
            Start Date: {membership[kind].start.toDate().toLocaleString()}
          </Text>
          <Text>
            End Date: {membership[kind].end.toDate().toLocaleString()}
          </Text>
        </View>
      );
    }
