  ...
  return (
    <SafeAreaView style={MyStyles.container}>
      <View style={{ flex: 1, justifyContent: "center" }}>
        ...
        <View
          style={[MyStyles.buttonShadow, { width: widthButton, height: "45%" }]}
        >
                    ...
                    <Button
                      ...
                      onPress={() => {
                        if (changePhone.length === 13) {
                          ...
                          Alert.alert("Error", "Input correct phone Number", [
                            { text: "OK" },
                          ]);
                        }
                      }}
                ...
                >
                  ...
                  >
                    <View style={AuthStyles.textView}>
                      <Text style={AuthStyles.text}>Enter Change Email</Text>
                      <TextInput
                        style={[
                    ...
                    <Button title="Check Email" onPress={checkUsedEmail} />
                    <View style={AuthStyles.textView}>
